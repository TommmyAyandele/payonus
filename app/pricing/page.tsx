...
const TESTIMONIALS = [
  ...
  {
    quote: "\"Before Payonus, cross-border settlements were a weekly fire drill. Now it's just seamless. Our finance team has genuinely stopped worrying about it.\"",
    name:  "John Kent",
    title: "Head of Finance, Bet9ja",
  },
];
...
const FAQS = [
  {
    ...
    a: "No. There are no setup fees, activation fees, or minimum commitments on our Starter plan. You only pay for what you process.",
  },
  {
    q: "Can I switch plans mid-month?",
    a: "Yes. You can upgrade or downgrade at any time. Changes take effect immediately and billing is prorated for the remainder of the billing cycle.",
  },
  {
    q: "Are there volume discounts?",
    a: "Yes. Enterprise customers and high-volume businesses are eligible for custom pricing. Reach out to our sales team to discuss your volume and get a tailored rate.",
  },
  {
    q: "What currencies are fees charged in?",
    a: "Fees are charged in the local currency of each transaction. For international transfers, fees are calculated in the transaction currency before settlement.",
  },
];
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;}
        ...
        .pricing-card:hover{transform:translateY(-4px);box-shadow:0 16px 48px rgba(96,9,255,.10);}

        table{border-collapse:collapse;width:100%;}
        th{text-align:left;}
        tbody tr:hover td{background:rgba(96,9,255,.025);}

        .faq-row:first-child{border-top:1px solid ${T.borderLight};}
        .faq-row{border-bottom:1px solid ${T.borderLight};}
      ...
      <section style={{
        ...
        overflow:"hidden",
        padding: isMobile ? "72px 0 80px" : "96px 0 108px",
      }}>
        ...
        <img
          ...
          style={{
            ...
            width: isMobile ? 360 : isTablet ? 520 : 680,
            opacity:0.30, pointerEvents:"none", zIndex:0,
          }}
        />
        ...
        <div style={{position:"relative",zIndex:1,maxWidth:1440,margin:"0 auto",padding:`0 ${hPad}px`}}>
          ...
          <div className="fade-up d2" style={{
            ...
            <div className="pricing-card" style={{
              ...
              <p style={{
                margin:"0 0 6px",
                fontFamily:"Rubik, sans-serif", fontWeight:700, fontStyle:"italic",
                fontSize: isMobile ? 56 : 68, lineHeight:1, color:T.headingBlack,
              }}>1.5%</p>

              <p style={{
                margin:"0 0 28px",
                fontFamily:"DM Sans, sans-serif", fontWeight:400, fontSize:15, color:T.muted,
              }}>Capped at 2000</p>

              <div style={{height:1,background:T.borderLight,marginBottom:28,marginTop:"auto"}}/>
            ...
            {/* Right: International Transactions (highlighted) */}
            <div className="pricing-card" style={{
              background:T.white,
              ...
              padding: isMobile ? "28px 24px" : "32px 28px",
              display:"flex", flexDirection:"column",
              boxShadow:`0 0 0 5px rgba(96,9,255,0.07)`,
            }}>
              <span style={{
                display:"block", marginBottom:20,
                fontFamily:"DM Sans, sans-serif", fontWeight:600, fontSize:13,
              ...
              <p style={{
                margin:"0 0 6px",
                fontFamily:"Rubik, sans-serif", fontWeight:700, fontStyle:"italic",
                fontSize: isMobile ? 36 : 46, lineHeight:1.1, color:T.headingBlack,
              }}>Custom rate</p>
      ...
      <section style={{width:"100%",background:T.bg,padding: isMobile ? "64px 0" : "88px 0 108px"}}>
        <div style={{maxWidth:1440,margin:"0 auto",padding:`0 ${hPad}px`}}>
          ...
          <div className="fade-up d2" style={{overflowX:"auto",WebkitOverflowScrolling:"touch"}}>
            <table style={{minWidth:640,fontFamily:"DM Sans, sans-serif"}}>
              ...
              <tbody>
                {TABLE_ROWS.map((row,i)=>(
                  <tr key={i}>
                    <td style={{padding:"14px 20px 14px 0",fontSize:14,fontWeight:500,color:T.dark,whiteSpace:"nowrap",borderBottom:`1px solid ${T.borderLight}`}}>{row.country}</td>
      ...
      <section style={{width:"100%",background:T.bg,padding: isMobile ? "64px 0" : "88px 0"}}>
        <div style={{maxWidth:1440,margin:"0 auto",padding:`0 ${hPad}px`}}>
          ...
          <span className="fade-up" style={{
            display:"block", marginBottom: isMobile ? 36 : 52,
            fontFamily:"DM Sans, sans-serif", fontWeight:500, fontSize:13,
            color:T.orange, letterSpacing:"0.06em",
          }}>— Testimonials</span>
          ...
          <div className="fade-up d1" style={{
            ...
            {(isMobile || isTablet ? [TESTIMONIALS[testimonialIdx]] : TESTIMONIALS).map((t,i)=>(
              <div key={i} style={{display:"flex",flexDirection:"column",gap:24}}>
                <p style={{
                  margin:0,
                  fontFamily:"Rubik, sans-serif", fontStyle:"italic", fontWeight:700,
                  fontSize: isMobile ? 19 : 22, lineHeight:1.55, color:NAVY,
                }}>{t.quote}</p>
                <div>
                  <p style={{margin:"0 0 3px",fontFamily:"DM Sans, sans-serif",fontWeight:700,fontSize:15,color:T.dark}}>{t.name}</p>
                  <p style={{margin:0,fontFamily:"DM Sans, sans-serif",fontWeight:400,fontSize:14,color:T.muted}}>{t.title}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          {/* Arrow nav */}
          <div className="fade-up d2" style={{display:"flex",gap:8}}>
            {[
              ...
              <button
                ...
                onMouseEnter={e=>{e.currentTarget.style.background="#F5EFF7";e.currentTarget.style.borderColor=T.primary;}}
                onMouseLeave={e=>{e.currentTarget.style.background="transparent";e.currentTarget.style.borderColor=T.borderLight;}}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <path d={d} stroke={T.dark} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
            ))}
          </div>
      ...
      <section style={{width:"100%",background:T.bg,padding: isMobile ? "64px 0" : "88px 0"}}>
        <div style={{maxWidth:1440,margin:"0 auto",padding:`0 ${hPad}px`}}>
          ...
          <div className="fade-up d2" style={{maxWidth:800}}>
            {FAQS.map((faq,i)=>(
              <div key={i} className="faq-row">
                ...
                >
                  <span style={{
                    ...
                    fontSize: isMobile ? 15 : 16, color:T.dark,
                  }}>{faq.q}</span>
                  <span style={{
