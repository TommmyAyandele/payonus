...
export const metadata = { title: "Gaming | Payonus", description: "Payment rails built for the speed of play. In-game purchases, creator payouts, and tournament prizes — Payonus keeps your players in the game." };
