...
const blocks: IndustryBlock[] = [
  ...
  },
  {
    ...
    items: [
      { icon: "card", title: "Invoice Payments", desc: "Support collections around invoice-based B2B transactions.", illustration: "invoiceDoc" },
      { icon: "route", title: "Bank Transfers", desc: "Account-based options for completing payments.", illustration: "bankApp" },
      { icon: "wallet", title: "Card Payments", desc: "Support card payments where they fit your model.", illustration: "cardTap" },
      { icon: "link", title: "Payment Links", desc: "Direct payment journeys for specific invoices.", illustration: "qrLink" },
      { icon: "clock", title: "Deposits & Milestones", desc: "Structured payment journeys with staged amounts.", illustration: "milestoneDeal" },
      { icon: "globe", title: "Multi-Currency", desc: "Relevant currencies and markets where available.", illustration: "currencyExchange" },
      { icon: "users", title: "Distributor Collections", desc: "Across distributor and business-customer relationships.", illustration: "halima" },
