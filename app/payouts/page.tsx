  ...
  return (
    <div style={{ borderRadius:10, overflow:"hidden", border:"1px solid #DCDCDC", boxShadow:"0 4px 28px rgba(0,0,0,0.07)", background:"#FFF", userSelect:"none", pointerEvents:"none" }}>
      ...
      <div style={{ background:"#F5F5F5", display:"flex", alignItems:"center", padding:"6px 12px", gap:7, borderBottom:"1px solid #EBEBEB" }}>
        {["←","→","↺","⌂"].map((ic,i) => (
          <span key={i} style={{ fontSize:11,color:"#AAAAAA",lineHeight:1,flexShrink:0 }}>{ic}</span>
        ))}
        ...
        <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 16px",borderBottom:"1px solid #F0F0F0",background:"#FFF" }}>
          <div style={{ display:"flex",alignItems:"center",gap:14 }}>
            ...
            <div style={{ display:"flex",alignItems:"center",gap:6 }}>
              <div style={{ width:26,height:14,borderRadius:7,position:"relative",...sk }}>
                <div style={{ width:10,height:10,borderRadius:"50%",background:"rgba(255,255,255,0.55)",position:"absolute",top:2,left:2 }} />
              </div>
              <div style={{ width:44,height:6,borderRadius:3,...sk }} />
            </div>
          </div>
          ...
          <div style={{ width:175,flexShrink:0,background:"#FAFAFA",borderRight:"1px solid #F0F0F0",padding:"12px 10px",display:"flex",flexDirection:"column",gap:9 }}>
            ...
            {[0,1,2,3,4,5].map((i,_,arr) => (
              <div key={i} style={{ display:"flex",alignItems:"center",gap:8 }}>
                ...
                {i >= 3 && <div style={{ width:5,height:5,borderRadius:1,flexShrink:0,...sk }} />}
              </div>
            ))}
          </div>
                ...
                {[0,1,2].map(col => (
                  <div key={col} style={{ borderRadius:8,overflow:"hidden",background:"#F5F5F5" }}>
                    ...
                    <div style={{ padding:"8px 10px",display:"flex",flexDirection:"column",gap:6,background:"#FFF" }}>
                      <div style={{ width:"68%",height:6,borderRadius:3,...sk,animationDelay:`${(row*3+col)*0.06+0.05}s` }} />
                      <div style={{ width:"48%",height:5,borderRadius:3,...sk,animationDelay:`${(row*3+col)*0.06+0.1}s` }} />
                    </div>
                  </div>
                ))}
              </div>
...
const FEATURES = [
  {
    title: "Bulk payouts at scale",
    desc: "Send thousands of payouts in a single API call or CSV upload. Vendors, contractors, merchants — all paid at once, with full status tracking per recipient.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M12 5v14M5 12h14" stroke={T.primary} strokeWidth="1.8" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M12 15h2" stroke={T.primary} strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
    title: "Full audit trail",
    desc: "Immutable logs for every payout transaction. Finance and compliance teams get exportable, timestamped reports — ready for regulators, investors, or auditors.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <rect x="8" y="8" width="8" height="7" rx="1" stroke={T.primary} strokeWidth="1.5"/>
        <path d="M10 8V6a2 2 0 0 1 4 0v2" stroke={T.primary} strokeWidth="1.5" strokeLinecap="round"/>
        <path d="M4 20h16" stroke={T.primary} strokeWidth="1.5" strokeLinecap="round"/>
        <path d="M12 15v5" stroke={T.primary} strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
    title: "Webhook-ready",
    desc: "Get instant status updates for every payout state change — initiated, processing, settled, or failed. Build automated reconciliation flows without polling.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <circle cx="18" cy="5" r="2.5" stroke={T.primary} strokeWidth="1.5"/>
        <circle cx="6" cy="12" r="2.5" stroke={T.primary} strokeWidth="1.5"/>
        <circle cx="18" cy="19" r="2.5" stroke={T.primary} strokeWidth="1.5"/>
        <path d="M8.5 10.5l7-4M8.5 13.5l7 4" stroke={T.primary} strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
    title: "Compliance built in",
    desc: "Every payout is screened against OFAC, UN, and local African sanctions lists automatically. No extra integration, no compliance overhead on your end.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M5 13l4 4L19 7" stroke={T.primary} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
  {
    title: "Real-time settlement",
    desc: "Payouts confirm in seconds across NGN, GHS, KES, XOF, and more. No T+1, no weekend delays, no manual reconciliation headaches for your finance team.",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <circle cx="12" cy="12" r="9" stroke={T.primary} strokeWidth="1.5"/>
        <path d="M12 7v5l3.5 3.5" stroke={T.primary} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
];
...
/* Pre-split into rows of 4 for the scrolling track */
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; }
        ...
        footer a, footer button { font-family:"DM Sans",sans-serif; }
      ...
      <section style={{
        ...
        <div style={{
          ...
          padding: isMobile ? `80px 20px 60px` : `0 ${hPad}px`,
          ...
          <div style={{
            ...
            <span style={{
              ...
              fontSize: isMobile ? 12 : 14, letterSpacing: "0.08em", textTransform: "uppercase",
              color: T.orange,
            }}>• Payouts</span>
            ...
            <h1 style={{
              ...
              fontSize: isMobile ? 52 : isTablet ? 66 : 90,
        ...
        {/* Dashboard — normal flow below content, bottom half clipped by next section */}
        {!isMobile && (
          <div style={{
            position: "relative", zIndex: 1,
            maxWidth: 1440, margin: "0 auto",
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1440, margin: "0 auto", padding: `0 ${hPad}px` }}>
          ...
          <h2 className="fade-up" style={{
            ...
            Everything you need to<br />move money{" "}
            <span style={{ color: T.primary }}>fast.</span>
          </h2>
                ...
                return (
                  <div key={i} className="fade-up" style={{
                    ...
                    <p style={{
                      margin: "0 0 12px",
                      fontFamily: "DM Sans, sans-serif", fontWeight: 500,
                      fontSize: isMobile ? 16 : 20, lineHeight: 1.3, color: T.dark,
                    }}>{f.title}</p>
                    <p style={{
                      margin: 0,
                      fontFamily: "DM Sans, sans-serif", fontWeight: 400,
                      fontSize: 14, lineHeight: 1.65, color: T.muted,
                    }}>{f.desc}</p>
                  </div>
                );
              })}
          ...
          <div style={{
            ...
            <div>
              <h2 className="fade-up" style={{
                ...
                <span style={{ color: T.headingBlack }}>One integration,</span><br />
                <span style={{ color: T.primary }}>every market.</span>
              </h2>
              <p style={{
                margin: "0 0 32px",
                fontFamily: "Rubik, sans-serif", fontStyle: "italic", fontWeight: 400,
            ...
            <div style={{ position:"relative", overflow:"hidden", height: isMobile ? 280 : 460, maxWidth: isMobile ? "100%" : 380 }}>
              ...
              {/* Gradient fade at bottom — matches design's fade-out effect */}
              <div style={{
      ...
      <section style={{ width: "100%", background: T.bg, padding: `${isMobile ? 60 : 80}px 0` }}>
        <div style={{ maxWidth: 1440, margin: "0 auto", padding: `0 ${hPad}px` }}>
          ...
          <p style={{
            ...
            fontFamily: "DM Sans, sans-serif", fontWeight: 400,
            fontSize: 15, lineHeight: 1.65, color: T.muted, maxWidth: 520,
          }}>
            Every payout moves through an infrastructure your enterprise already requires.
          </p>
